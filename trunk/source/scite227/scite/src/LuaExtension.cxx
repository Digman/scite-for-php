...
//!-start-[OnStatusBarClick]
bool LuaExtension::OnStatusBarClick(int part, const char* text) {
	return CallNamedFunction("OnStatusBarClick", part, text);
}
//!-end-[OnStatusBarClick]
