...
void ScintillaBase::AddCharUTF(char *s, unsigned int len, bool treatAsDBCS, bool notifyChar) {//!-changed-AddCharUTF-[added notifyChar]
	bool isFillUp = ac.Active() && ac.IsFillUpChar(*s);
	if (!isFillUp) {
		//!-changed-AddCharUTF-[added notifyChar]
		Editor::AddCharUTF(s, len, treatAsDBCS, notifyChar);
	}
	if (ac.Active()) {
